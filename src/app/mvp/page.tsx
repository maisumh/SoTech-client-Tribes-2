  ...
  return (
    <div className="min-h-screen bg-offwhite">
      ...
      <main id="main">
        ...
        <section className="py-16 md:py-24 bg-offwhite">
          <div className="max-w-[1000px] mx-auto px-4">
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <p className="text-lg text-gray-600 max-w-[700px] mx-auto leading-relaxed">
                  Your existing contract got the app built. This is the layer
                  on top — the go-to-market system that turns the built app
                  into something we can learn from every week. Different
                  muscle, different billing.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
              <ScrollReveal>
                <div className="bg-white rounded-2xl p-7 h-full border-2 border-gray-100 hover:border-casablanca/40 transition-all">
                  <div className="text-xs font-bold tracking-wider uppercase text-gray-400 mb-3">
                    One-time
                  </div>
                  <h3 className="font-heading text-xl font-bold text-firefly mb-2">
                    MVP Launch Kit
                  </h3>
                  <div className="text-3xl font-extrabold text-firefly mb-4">
                    $1,500<span className="text-lg text-gray-400">–$2,500</span>
                  </div>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li>• Strategy doc + client walkthrough</li>
                    <li>• Branded invite email + Supabase setup</li>
                    <li>• Feedback form + in-app integration</li>
                    <li>• GHL form build + pre-fill wiring</li>
                  </ul>
                </div>
              </ScrollReveal>

              <ScrollReveal delay={0.1}>
                <div className="bg-firefly text-white rounded-2xl p-7 h-full shadow-xl relative">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-casablanca text-firefly text-xs font-bold px-3 py-1 rounded-full tracking-wide">
                    RECOMMENDED
                  </div>
                  <div className="text-xs font-bold tracking-wider uppercase text-casablanca mb-3">
                    Recurring
                  </div>
                  ...
                  <div className="text-3xl font-extrabold mb-4">
                    $600<span className="text-lg text-white/50">–$900/mo</span>
                  </div>
                  <ul className="space-y-2 text-sm text-white/80">
                    <li>• Weekly 45-min synth session</li>
                    <li>• Backlog shaping + prioritization</li>
                    <li>• Bi-weekly &quot;You said, we did&quot; updates</li>
                    <li>• Monthly metrics report</li>
                  </ul>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.2}>
                <div className="bg-white rounded-2xl p-7 h-full border-2 border-gray-100 hover:border-casablanca/40 transition-all">
                  ...
                  <div className="text-3xl font-extrabold text-firefly mb-4">
                    $400<span className="text-lg text-gray-400">–$600</span>
                  </div>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li>• Per 150 contacts</li>
                    <li>• Contact list intake + cleanup</li>
                    <li>• Delivery + open monitoring</li>
                    <li>• Follow-up nudges to non-responders</li>
                  </ul>
                </div>
              </ScrollReveal>
            </div>
            ...
            <ScrollReveal>
              <div className="bg-gradient-to-br from-granny/30 to-granny/10 rounded-2xl p-8 md:p-10 text-center border border-granny/30">
                <div className="text-xs font-bold tracking-widest uppercase text-casablanca-dark mb-2">
                  Bundle Offering
                </div>
                <h3 className="font-heading text-2xl md:text-3xl font-extrabold text-firefly mb-3">
                  MVP Launch Package
                </h3>
                <div className="text-4xl md:text-5xl font-extrabold text-firefly mb-2">
                  ~$8,500
                </div>
                <p className="text-gray-600 leading-relaxed max-w-[560px] mx-auto">
                  Launch Kit + 8 weeks of Feedback Loop Facilitation.
                  Everything you need to run an MVP that actually teaches you
                  something, from week zero to week eight.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        {/* Alternative single-price section */}
        <section className="py-16 md:py-24 bg-gradient-to-br from-firefly via-firefly to-firefly-light text-white relative overflow-hidden">
          <div
            className="absolute inset-0 opacity-[0.07] pointer-events-none"
            aria-hidden="true"
          >
            <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-casablanca blur-3xl" />
            <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-casablanca blur-3xl" />
          </div>
          ...
          <div className="relative max-w-[900px] mx-auto px-4">
            <ScrollReveal>
              <div className="text-center mb-10">
                ...
                <p className="text-lg text-white/75 max-w-[600px] mx-auto">
                  If the split breakdown feels like noise, here&apos;s the
                  alternative: everything above, bundled into a single
                  no-surprises line item.
                </p>
              </div>
            </ScrollReveal>

            <ScrollReveal>
              <div className="bg-offwhite text-ink rounded-3xl p-10 md:p-14 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-40 h-40 bg-casablanca/10 rounded-full blur-3xl" />
                <div className="absolute bottom-0 left-0 w-40 h-40 bg-firefly/5 rounded-full blur-3xl" />

                <div className="relative">
                  <div className="flex items-center justify-center gap-2 mb-4">
                    <span className="inline-flex items-center gap-1.5 bg-casablanca/20 text-casablanca-dark text-[10px] font-extrabold tracking-widest uppercase px-3 py-1 rounded-full">
                      <span className="w-1.5 h-1.5 rounded-full bg-casablanca-dark" />
                      All-in-one
                    </span>
                  </div>

                  <h3 className="font-heading text-2xl md:text-3xl font-extrabold text-firefly text-center mb-2">
                    MVP Launch Kit
                  </h3>
                  <p className="text-center text-gray-500 text-sm mb-8">
                    Everything, delivered as one package.
                  </p>

                  <div className="text-center mb-10">
                    <div className="inline-flex items-baseline gap-2">
                      <span className="text-6xl md:text-7xl font-extrabold text-firefly tracking-tight">
                        $2,000
                      </span>
                    ...
                    <p className="text-xs text-gray-400 mt-2 uppercase tracking-widest font-semibold">
                      One price · one invoice · one engagement
                    </p>
                  </div>

                  <div className="border-t border-gray-100 pt-8">
                    <div className="text-xs font-bold tracking-widest uppercase text-gray-400 text-center mb-5">
                      What&apos;s included
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                      {[
                        ...
                        "Supabase invite flow setup",
                        "8-question feedback form spec",
                        "In-app feedback integration",
                        "GHL form build & wire-up",
                        "FlutterFlow setup guide",
                        "Client walkthrough & kickoff call",
                      ].map((item) => (
                        <div
                          key={item}
                          className="flex items-start gap-2.5"
                        >
                          <span className="shrink-0 mt-1.5 w-4 h-4 rounded-full bg-casablanca flex items-center justify-center">
                            <svg
                              width="10"
                              height="10"
                              viewBox="0 0 24 24"
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                    <p className="text-xs text-gray-500 italic leading-relaxed max-w-[480px] mx-auto">
                      Note: ongoing feedback facilitation (weekly synth,
                      backlog shaping, user updates) is not included at this
                      price. Add it as a separate retainer if desired.
                    </p>
                  </div>
                </div>
              </div>
